...
<div class="mt-left">
  ...
  else { $new_title = "Comparatif : Les ".$total_avis." ".lcfirst($masculinsfeminins ?? 'meilleurs')." ".$type_de_produit_au_pluriel." 2026"; }
  ...
  <div class="mt-photo">
    ...
    <?php if ($post_type === 'comparatif') {
        echo '<img class="mt-badge" src="https://meilleurtest.fr/wp-content/uploads/2025/11/badge-mt.png" alt="" style="position:absolute;top:10px;left:10px;max-width:130px;height:auto;">';
    } ?>
  </div>
