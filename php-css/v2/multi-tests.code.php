...
/* =====================================================================
   ...
   - Dépend du snippet WPCodeBox v2/mtv2-core.php (sinon : liste V1).
   ===================================================================== */
...
/* ---------------------------------------------------------------------
   ...
   - V2 (snippet mtv2-core) : liste SANS DOUBLON du plan, dans l'ordre de
     1re apparition (encart principal, puis sous-comparatifs), coupée à
     MTV2_MAX_TESTS.
   - Sans le snippet : sourcing V1 (top_avis_ids, repli mltv5_best_products).
   --------------------------------------------------------------------- */
$page_id = get_the_ID();
$page_tv = function_exists( 'get_all_template_variables' ) ? get_all_template_variables( $page_id ) : array();
$plan    = function_exists( 'mtv2_plan' ) ? mtv2_plan( $page_id ) : null;
