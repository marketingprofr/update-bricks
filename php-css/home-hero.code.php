...
<section class="mt-hh">
  <div class="mt-hh-inner">
    ...
    <form class="mt-hh-search" method="get" action="<?php echo esc_url( $HH_SEARCH_ACTION ); ?>" role="search">
      ...
      <button type="submit">Rechercher <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m13 6 6 6-6 6"/></svg></button>
    </form>
    ...
    <div class="mt-hh-strip">
      <span class="mt-hh-stat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 6c-1.6-1.2-4-2-7-2v13c3 0 5.4.8 7 2 1.6-1.2 4-2 7-2V4c-3 0-5.4.8-7 2Z"/><path d="M12 6v13"/></svg> <b><?php echo esc_html( $hh_total_disp ); ?></b>&nbsp;guides d'achat</span>
      ...
      <span class="mt-hh-stat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg> Indépendant depuis <b><?php echo esc_html( $HH_YEAR ); ?></b></span>
      <span class="mt-hh-stat"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="m8.5 12.5 2.2 2.2L16 9"/></svg> <b>0 %</b>&nbsp;de publicité</span>
    </div>
  </div>
</section>
